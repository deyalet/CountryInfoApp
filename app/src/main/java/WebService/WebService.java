...
import com.example.countryinfoapp.MainActivity;
...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    public WebService(String urlWebService, Map<String, String> datos, MainActivity activity, MainActivity mainActivity) {
